    ...
    MAIN_LOOP : while (true) {
      ...
      if (menuNo == 0) {
        ...
        while(true) {
          ...
          menuNo = Prompt.inputInt("게시판>");
          switch(menuNo){
            case 1: memberHandler.add();
            case 2: memberHandler.list();
            case 3: memberHandler.detail();
            case 4: memberHandler.update();
            case 5: memberHandler.delete();
            case 0: continue MAIN_LOOP;
            default:
        ...
        LOOP: while(true) {
          ...
          menuNo = Prompt.inputInt("게시판>");
          switch(menuNo){
            case 1: projectHandler.add();
            case 2: projectHandler.list();
            case 3: projectHandler.detail();
            case 4: projectHandler.update();
            case 5: projectHandler.delete();
            case 0: continue MAIN_LOOP;
            default:
        ...
        LOOP: while(true) {
          ...
          menuNo = Prompt.inputInt("게시판>");
          switch(menuNo){
            case 1: taskHandler.add();
            case 2: taskHandler.list();
            case 3: taskHandler.detail();
            case 4: taskHandler.update();
            case 5: taskHandler.delete();
            case 0: continue MAIN_LOOP;
            default:
              System.out.println("무효한 메뉴 번호입니다.");
          }

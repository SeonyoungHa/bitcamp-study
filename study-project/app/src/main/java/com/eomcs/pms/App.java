...
public class App {
	...
	public App() {
		...
		commandMap.put("/board/search", new BoardDeleteHandler(boardList));
		...
		commandMap.put("/project/add", new ProjectAddHandler(projectList, memberPromptHandler));
		...
		commandMap.put("/project/update", new ProjectUpdateHandler(projectList, memberPromptHandler));
		commandMap.put("/project/delete", new ProjectDeleteHandler(projectList));

		commandMap.put("/task/add",new TaskAddHandler(projectListHandler));
		commandMap.put("/task/list", new TaskListHandler(projectListHandler));
		commandMap.put("/task/detail", new TaskDetailHandler(projectListHandler));
		commandMap.put("/task/update", new TaskUpdateHandler(projectListHandler)));
		commandMap.put("/task/delete", new TaskDeleteHandler(projectListHandler));

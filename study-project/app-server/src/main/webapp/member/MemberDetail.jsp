...
<div class="mb-3 row">
    ...
    <div class="col-sm-6">
    <input id='f-no' type='text' name='no' class="form-control" value='${member.no}' readonly><br>
    </div>
  </div>    
...
<div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input id='f-registeredDate' class="form-control" value="${member.registeredDate}" readonly><br>
    </div>
  </div>
  
<button>변경</button>
 <a href='delete.jsp?no=${member.no}'>[삭제]</a> 
 <a href='list'>[목록]</a><br>
</form>
